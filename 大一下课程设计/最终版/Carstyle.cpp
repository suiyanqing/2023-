#include"Carstyle.h"
Carstyle::Carstyle(string m,bool zu,string L) :brand(m),ZU(zu),location(L)
{
...
int Carstyle::GET_D_NUM()
{
	return 1;
}
int Carstyle::GET_C_ID()
{
	return 1;
}
int Carstyle::GET_C_MILE()
...
int Carstyle::GET_C_VALUE()
{
	return 1;
}
string& Carstyle::R_BRAND()
{
	return brand;
}
int Carstyle::GET_ZU()
